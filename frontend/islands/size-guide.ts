 ...
 * Size Guide Island
 *
 * Modal component for displaying size guide tables.
 * Handles open/close behavior, focus trapping, and keyboard navigation.
 *
 * Hydration: client:idle (not critical path)
 */

class SizeGuideIsland extends HTMLElement {
  ...
  connectedCallback() {
    console.log('[Island] size-guide hydrated (client:idle)')
...
customElements.define('size-guide-island', SizeGuideIsland)
